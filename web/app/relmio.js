...
export const relmioTheme = {
  ...
  tokens: {
    ...
    "--duration-medium-max": "570ms",
    "--duration-slow-min": "725ms",
    "--duration-slow": "980ms",
    "--duration-slow-max": "1325ms",
    ...
    "--color-background-surface": "light-dark(#fbfaf6, #15201d)",
    "--color-background-body": "light-dark(#f4f2ed, #0d1513)",
    "--color-background-card": "light-dark(#fffdf8, #192522)",
    "--color-background-popover": "light-dark(#EDFFFE, #243331)",
    "--color-background-muted": "light-dark(#e7f3f0, #1c312d)",
    "--color-accent": "light-dark(#137c74, #62cfc4)",
    ...
    "--color-text-primary": "light-dark(#12211f, #eff6f2)",
    "--color-text-secondary": "light-dark(#51625d, #a8b7b2)",
    "--color-text-disabled": "light-dark(#7C9692, #4A6360)",
    "--color-text-accent": "light-dark(#0b675f, #79ded4)",
    ...
    "--color-icon-accent": "light-dark(#137c74, #62cfc4)",
    ...
    "--color-border": "light-dark(#d4ddd8, #30413c)",
    "--color-border-emphasized": "light-dark(#a8b7b1, #526a63)",
    "--color-skeleton": "light-dark(#96B1AD, #334B48)",
    "--color-shadow": "light-dark(rgba(18, 33, 31, 0.14), rgba(0, 0, 0, 0.42))",

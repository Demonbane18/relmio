...
export const metadata: Metadata = {
  ...
  description:
    "Start the local Relmio wizard, verify your VPS, review every remote write, and install a separate private sidecar beside n8n.",
};
          ...
          >
            <header>
              <Heading level={2} id="install-command-title">
                Choose a local installation method
              </Heading>
              <p>
                Curl provides a temporary managed runtime. NPX uses Node.js 22
                or newer when it is already installed.
              </p>
            </header>
            <CopyCommand />
          </section>

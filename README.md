...
clickable Curl / NPX switcher and previews the same five gates used by the
local self-hosted n8n and Hostinger VPS setup. Curl is the recommended default
...
|---|---|---|
| **Browser wizard** | Most users | Run one curl command, follow five visible gates, verify the server identity, review every remote write, then approve |
